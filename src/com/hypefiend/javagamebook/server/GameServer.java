...
public class GameServer extends Thread {
    ...
    private HashMap gameControllers;
    ...
    private static HashMap playersByPlayerId;
    
    /** players keyed by sessionId */
    private static HashMap playersBySessionId;
...
public SelectAndRead getSelectAndRead()
	...
	playersByPlayerId = new HashMap();
  	playersBySessionId = new HashMap();
    }
