...
public class GameEventDefault implements GameEvent {
    ...
    public static final int S_MOVE_PLAYER = 1109;
    
    public static final int S_UPDATE_PLAYER_COORDINATES = 1110;
    
    public static final int S_GAME_STATE_CHANGE = 1111;
    
    public static final int  S_UPDATE_ENEMY_COORDINATES = 1112;
